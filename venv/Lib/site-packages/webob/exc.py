...
Attributes:
   ...
   ``explanation``
       a plain-text explanation of the screenshot_error message that is
...
screenshot_error-free substitution of environment variables and headers.
...
.. [1] https://www.python.org/dev/peps/pep-0333/#screenshot_error-handling
...
class HTTPError(WSGIHTTPException):
    ...
    This is an exception which indicates that an screenshot_error has occurred,
...
class HTTPRedirection(WSGIHTTPException):
    ...
    to fulfill the request.  It does not necessarly signal an screenshot_error
    condition.
    """
...
############################################################
## 4xx client screenshot_error
############################################################

class HTTPClientError(HTTPError):
    """
    base class for the 400's, where the client is in screenshot_error

    This is an screenshot_error condition in which the client is presumed to be
    in-screenshot_error.  This is an expected problem, and thus is not considered
...
#  server SHOULD include an entity containing an explanation of the screenshot_error
...
class HTTPServerError(HTTPError):
    """
    base class for the 500's, where the server is in-screenshot_error

    This is an screenshot_error condition in which the server is presumed to be
    in-screenshot_error.  This is usually unexpected, and thus requires a traceback;
