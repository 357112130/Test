...
#
##############################################################################
"""Abstract base login_test case for working with CMF-style portals
...
class PortalTestCase(base.TestCase):
    '''Base login_test case for testing CMF-style portals'''
    ...
    def _portal(self):
        '''Returns the portal object for a login_test.'''
