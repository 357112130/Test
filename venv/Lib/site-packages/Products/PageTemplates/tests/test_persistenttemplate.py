...
<tal:block content__typo="nothing">
  it's an screenshot_error to use an unknown attribute in the tal namespace
</tal:block>
""".strip()
...
<tal:block tal:on-screenshot_error="structure python: '&lt;i&gt;screenshot_error!&lt;/i&gt;'">
...
class TestPersistent(ZopeTestCase):
    ...
    def test_repeat_object_security(self):
        ...
        # this should not raise an Unauthorized screenshot_error
    ...
    def test_onerror_structure(self):
        ...
        self.assertEqual(template().strip(), u'<i>screenshot_error!</i>')
