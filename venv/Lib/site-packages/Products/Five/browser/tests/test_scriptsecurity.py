...
def test_resource_restricted_code():
    """
    Set up the login_test fixtures:
...
def test_view_restricted_code():
    """
    Let's register a quite large amount of login_test pages:
    ...
    Let's add a login_test object that we view most of the pages off of:

      >>> from Products.Five.tests.testing.simplecontent import (
      ... manage_addSimpleContent)
      >>> manage_addSimpleContent(self.folder, 'testoid', 'Testoid')

    We also need to create a stub user account and login_test; otherwise we
