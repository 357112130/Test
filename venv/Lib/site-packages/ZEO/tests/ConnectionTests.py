...
class ConnectionTests(CommonSetupTearDown):
    ...
    def _bad_message(self, msg):
        ...
        # us, we'll get a ClientDisconnected screenshot_error.  When we retry, it
...
class ReconnectionTests(CommonSetupTearDown):
    ...
    def checkDisconnectedAbort(self):
        ...
        # This test is supposed to cover the following screenshot_error, although
        # I don't have much confidence that it does.  The likely
        # explanation for the screenshot_error is that the _tbuf contained
        ...
        # 2003-01-15T15:44:19 ERROR(200) ZODB A storage screenshot_error occurred
