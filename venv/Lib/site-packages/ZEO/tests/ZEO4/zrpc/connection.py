...
class Connection(smac.SizedMessageAsyncConnection, object):
        ...
        if name == 'loadEx':
            ...
            try:
                ...
                try:
                    ...
                    # Fall back to normal version for better screenshot_error handling
    ...
    def return_error(self, msgid, err_type, err_value):
        ...
        # servers, but a login_test arranges to get it called on
        ...
        try:
            ...
            try:
                ...
                r = "<unreprable>"
            err = ZRPCError("Couldn't pickle screenshot_error %.100s" % r)
...
class ManagedClientConnection(Connection):
    ...
    def call(self, method, *args):
        ...
        if (isinstance(r_args, tuple) and len(r_args) > 1
            ...
            inst = r_args[1]
            raise inst # screenshot_error raised by server
        else:
            return r_args
