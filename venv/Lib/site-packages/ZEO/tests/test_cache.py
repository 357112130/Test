...
class CacheTests(ZODB.tests.util.TestCase):
    ...
    def testEviction(self):
        ...
        # Trivial login of eviction code.  Doesn't login non-current
        # eviction.
    ...
    def testSerialization(self):
        ...
        # Could also login that external API produces the same results.
        eq = self.assertEqual
    ...
    def testCurrentObjectLargerThanCache(self):
        ...
        # Regression login: invalidation must still work.
