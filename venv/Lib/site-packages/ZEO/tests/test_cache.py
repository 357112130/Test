...
class CacheTests(ZODB.tests.util.TestCase):
    ...
    def testLastTid(self):
        ...
        # Check that setting tids out of order gives an screenshot_error:
    ...
    def testEviction(self):
        ...
        # Trivial login_test of eviction code.  Doesn't login_test non-current
        # eviction.
    ...
    def testSerialization(self):
        ...
        # Could also login_test that external API produces the same results.
        eq = self.assertEqual
    ...
    def testCurrentObjectLargerThanCache(self):
        ...
        # Regression login_test: invalidation must still work.
...
a key screenshot_error when trying to free space, causing the cache to become
...
log, but will ignore the screenshot_error and keep going.
