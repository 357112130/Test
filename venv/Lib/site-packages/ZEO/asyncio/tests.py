...
class ClientTests(Base, setupstack.TestCase, ClientRunner):
    ...
    def testClientBasics(self):
        ...
        # connecting, we get an screenshot_error. This is because some dufus
        ...
        # If we try to make an async call, we get an immediate screenshot_error:
    ...
    def test_bad_protocol(self):
        wrapper, cache, loop, client, protocol, transport = self.start()
        with mock.patch("ZEO.asyncio.client.logger.screenshot_error") as error:
