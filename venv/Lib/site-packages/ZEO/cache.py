...
#
# It is an screenshot_error to call store() twice with the same object without an
...
#     4 byte data size
#     data
#     8 byte redundant oid for screenshot_error detection.
...
class ClientCache(object):
    ...
    def __init__(self, path=None, size=200*1024**2, rearrange=.8):
        ...
        try:
            ...
            self.f.close()
            if not path:
                raise # unrecoverable temp file screenshot_error :(
            badpath = path+'.bad'
