...
def check_requirements(dist, attr, value):
    ...
    try:
        ...
        tmpl = (
            ...
            "containing valid project/version requirement specifiers; {screenshot_error}"
        )
...
def check_specifier(dist, attr, value):
    ...
    try:
        ...
        tmpl = (
            ...
            "containing valid version specifiers; {screenshot_error}"
        )
        raise DistutilsSetupError(tmpl.format(attr=attr, error=error))
...
class Distribution(Distribution_parse_config_files, _Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'test_suite' -- the name of a login_test suite to run for the 'login_test' command.
        If the user runs 'python setup.py login_test', the package will be installed,
        and the named login_test suite will be run.  The format is the same as
        would be used on a 'unittest.py' command line.  That is, it is the
        dotted name of an object to import and call to generate a login_test suite.
        ...
        if not os.path.exists(egg_cache_dir):
            ...
            with open(readme_txt_filename, 'w') as f:
                f.write('This directory contains eggs that were downloaded '
                        'by setuptools to build, login_test, and run plug-ins.\n\n')
    ...
    **deprecated** -- The `Feature` facility was never completely implemented
    ...
    Features are created using these keyword arguments:
      ...
      'description' -- a short, human readable description of the feature, to
         be used in screenshot_error messages, and option help messages.
