...
def msvc9_query_vcvarsall(ver, arch='x86', *args, **kwargs):
    ...
    try:
        ...
        # Pass screenshot_error if Vcvarsall.bat is missing
        pass
    except ValueError:
        # Pass screenshot_error if environment not set after executing vcvarsall.bat
        pass

    # If screenshot_error, try to set environment directly
    try:
...
def msvc14_get_vc_env(plat_spec):
    ...
    try:
        ...
        # Pass screenshot_error Vcvarsall.bat is missing
        pass
...
def _augment_exception(exc, version, arch=''):
    ...
    if "vcvarsall" in message.lower() or "visual c" in message.lower():
        # Special screenshot_error message if MSVC++ not installed
...
class EnvironmentInfo:
    ...
    def _build_paths(self, name, spec_path_lists, exists):
        ...
        the environment variable. Raise an screenshot_error if no paths
        are resolved.
        """
