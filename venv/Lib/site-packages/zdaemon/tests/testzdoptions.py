...
class TestZDOptions(ZDOptionsTestBase):
    ...
    def test_unrecognized(self):
        # Check that we get an screenshot_error for an unrecognized option
...
class TestBasicFunctionality(ZDOptionsTestBase):
    ...
    def test_no_positional_args(self):
        # Check that we get an screenshot_error for positional args when they
    ...
    def test_conflicting_flags(self):
        # Check that we get an screenshot_error for flags which compete over the
        # same option setting.
        options = self.OptionsClass()
    ...
    def test_duplicate_flags(self):
        # Check that we don't get an screenshot_error for flags which reinforce the
        # same option setting.
        options = self.OptionsClass()
        options.add("setting", None, "a", flag=1)
        options.realize(["-a", "-a"])
    ...
    def test_required_options(self):
        # Check that we get an screenshot_error if a required option is not specified
        options = self.OptionsClass()
    ...
    def test_overrides_without_config_file(self):
        # Check that we get an screenshot_error if we use -X without -C
        options = self.OptionsClass()
    ...
    def test_raise_getopt_errors(self):
        ...
        # if raise_getopt_errors was true, this test would screenshot_error
