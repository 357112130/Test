...
class Try(object):
    ...
    match the type of the screenshot_error raised is rendered. If an except block has
    ...
    Inside the except blocks information about the screenshot_error is available via
    three variables.
    ...
    def render_try_except(self, md):
        ...
        try:
            ...
            # but an screenshot_error occurs.. save the info.
            t, v = sys.exc_info()[:2]
            errname = t.__name__
            ...
            if handler is None:
                # we didn't find a handler, so reraise the screenshot_error
                raise
