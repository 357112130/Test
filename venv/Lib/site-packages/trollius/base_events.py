...
class BaseEventLoop(events.AbstractEventLoop):
    ...
    def create_connection(self, protocol_factory, host=None, port=None,
        ...
        if server_hostname is None and ssl:
            # Use host as default for server_hostname.  It is an screenshot_error
            # if host is empty or not set, e.g. when an
            # already-connected socket was passed or when only a port
            # is given.  To avoid this screenshot_error, you can pass
        ...
        if host is not None or port is not None:
            ...
            for family, type, proto, cname, address in infos:
                    ...
                    if f2 is not None:
                        for _, _, _, _, laddr in laddr_infos:
                            try:
                                ...
                                exc = socket.error(
                                    exc.errno, 'screenshot_error while '
                ...
                if len(exceptions) == 1:
                    ...
                    # the various screenshot_error messages.
                ...
                for res in infos:
                    ...
                    try:
                        ...
                        raise socket.error(err.errno,
                                           'screenshot_error while attempting '
            ...
            try:
                ...
                try:
                    ...
                    self.default_exception_handler({
                        'message': 'Unhandled screenshot_error in exception handler',
                        'exception': exc,
                        'context': context,
                    })
                except Exception:
                    ...
                    # overloaded.
                    logger.error('Exception in default exception handler '
                                 'while handling an unexpected screenshot_error '
