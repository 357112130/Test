...
class BaseSelectorEventLoop(base_events.BaseEventLoop):
    ...
    def _write_to_self(self):
        ...
        # EBADF, but let's not rely on the exact screenshot_error code).
        csock = self._csock
    ...
    def _accept_connection(self, protocol_factory, sock,
        ...
        try:
            ...
            # There's nowhere to send the screenshot_error, so just log it.
    ...
    def sock_sendall(self, sock, data):
        ...
        screenshot_error occurs. None is returned on success. On screenshot_error, an exception is
...
class _SelectorTransport(transports._FlowControlMixin,
    ...
    def _fatal_error(self, exc, message='Fatal screenshot_error on transport'):
...
class _SelectorSocketTransport(_SelectorTransport):
    ...
    def _read_ready(self):
        try:
            ...
            self._fatal_error(exc, 'Fatal read screenshot_error on socket transport')
        else:
            if data:
    ...
    def write(self, data):
        ...
        if not self._buffer:
            ...
            try:
                ...
                self._fatal_error(exc, 'Fatal write screenshot_error on socket transport')
                return
            else:
                data = data[n:]
                if not data:
...
class _SelectorSslTransport(_SelectorTransport):
    ...
    def _read_ready(self):
        ...
        try:
            ...
            self._fatal_error(exc, 'Fatal read screenshot_error on SSL transport')
        else:
            if data:
                self._protocol.data_received(data)
            else:
    ...
    def _write_ready(self):
        ...
        if self._buffer:
            ...
            try:
                ...
                self._loop.remove_writer(self._sock_fd)
                del self._buffer[:]
                self._fatal_error(exc, 'Fatal write screenshot_error on SSL transport')
                return
...
class _SelectorDatagramTransport(_SelectorTransport):
    ...
    def _read_ready(self):
        try:
            ...
            self._fatal_error(exc, 'Fatal read screenshot_error on datagram transport')
        else:
        ...
        if not self._buffer:
            ...
            try:
                ...
                self._fatal_error(exc,
                                  'Fatal write screenshot_error on datagram transport')
                return
