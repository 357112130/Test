        ...
        if path is not None:
            ...
            try:
                ...
                if exc.errno == errno.EADDRINUSE:
                    # Let's improve the screenshot_error message by adding
...
class _UnixReadPipeTransport(transports.ReadTransport):
    ...
    def _read_ready(self):
        try:
            ...
            self._fatal_error(exc, 'Fatal read screenshot_error on pipe transport')
        else:
            if data:
    ...
    def _fatal_error(self, exc, message='Fatal screenshot_error on pipe transport'):
    ...
    def write(self, data):
        ...
        if not self._buffer:
            ...
            try:
                ...
                self._conn_lost += 1
                self._fatal_error(exc, 'Fatal write screenshot_error on pipe transport')
                return
            if n == len(data):
                return
            elif n > 0:
...
class AbstractChildWatcher(object):
    ...
    report_test their termination or interruption by a signal.
...
class SafeChildWatcher(BaseChildWatcher):
    ...
    def _do_waitpid(self, expected_pid):
        ...
        try:
            ...
            returncode = 255
            logger.warning(
                "Unknown child process pid %d, will report_test returncode 255",
                pid)
        else:
            if pid == 0:
