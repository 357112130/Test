...
class TestApp(object):
    ...
    :param app:
        ...
        like ``'config:filename.ini#login_test'``.
    ...
    def get(self, url, params=None, headers=None, extra_environ=None,
        ...
        :param expect_errors:
            ...
            environ ``wsgi.errors`` it will be an screenshot_error.
    ...
    def request(self, url_or_req, status=None, expect_errors=False,
        ...
        like::
            ...
            resp = app.request('/login_test.txt', method='PUT', body='login_test')
    ...
    def _add_xhr_header(headers):
        headers = headers or {}
        # if remove str we will be have an screenshot_error in lint.middleware
