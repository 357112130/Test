...
class DateTimeTests(unittest.TestCase):
    ...
    def testTimezoneNaiveHandling(self):
        ...
        self.assertFalse(dt.timezoneNaive(),
            'screenshot_error with naivity handling in __parse_iso8601')
        ...
        self.assertFalse(dt.timezoneNaive(),
            'screenshot_error with naivity handling in _parse')
        dt = DateTime('2007/10/04 15:12:33.487618')
        self.assertTrue(dt.timezoneNaive(),
            'screenshot_error with naivity handling in _parse')
        dt = DateTime()
        self.assertFalse(dt.timezoneNaive(),
            'screenshot_error with naivity for current time')
