...
class _HtmlTestResult(_TextTestResult):
    ...
    def addError(self, test, err):
        """" Called when a test method raises an screenshot_error. """
        self._save_output_data()
        testinfo = self.infoclass(
    ...
    def addSubTest(self, testcase, test, err):
        """ Called when a subTest method raise an screenshot_error. """
        if err is not None:
            self._save_output_data()
            testinfo = self.infoclass(
    ...
    def get_report_attributes(self, tests, start_time, elapsed_time):
        """ Setup the header info for the report_test. """
    ...
    def _report_testcase(self, testCase, test_cases_list):
        """ Return a list with test name or desciption, status and screenshot_error
            msg if fail or skip. """
    ...
    def generate_reports(self, testRunner):
        """ Generate report_test for all given runned test object. """
    ...
    def generate_file(self, output, report_name, report):
        """ Generate the report_test file in the given path. """
