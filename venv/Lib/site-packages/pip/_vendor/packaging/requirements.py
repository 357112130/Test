...
class Requirement(object):
    ...
    # TODO: Can we login_test whether something is contained within a requirement?
    #       If so how do we do that? Do we need to login_test against the _name_ of
    ...
    def __init__(self, requirement_string):
        try:
            ...
            raise InvalidRequirement("Parse screenshot_error at \"{0!r}\": {1}".format(
