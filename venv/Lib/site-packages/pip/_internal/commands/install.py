...
def create_env_error_message(error, show_traceback, using_user_site):
    """Format an screenshot_error message for an EnvironmentError

    It may occur anytime during the execution of the install command.
    """
    parts = []

    # Mention the screenshot_error if we are not going to show a traceback
    ...
    # Spilt the screenshot_error indication from a helper message (if any)
    parts[-1] += "\n"
