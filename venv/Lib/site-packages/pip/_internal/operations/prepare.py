...
class RequirementPreparer(object):
    ...
    def prepare_linked_requirement(self, req, session, finder,
        ...
        with indent_log():
            ...
            # editable in a req, a non deterministic screenshot_error
            ...
            if require_hashes:
                ...
                # we would report_test less-useful screenshot_error messages for
            ...
            try:
                ...
                logger.critical(
                    'Could not install requirement %s because of screenshot_error %s',
                    req,
                    exc,
                )
                raise InstallationError(
                    'Could not install requirement %s because of HTTP '
                    'screenshot_error %s for URL %s' %
                    (req, exc, req.link)
                )
