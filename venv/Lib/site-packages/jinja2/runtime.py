...
class LoopContextBase(object):
    ...
    # a nifty trick to enhance the screenshot_error message if someone tried to call
    ...
    class LoggingUndefined(base):
        ...
        def _fail_with_undefined_error(self, *args, **kwargs):
            try:
                ...
                logger.error('Template variable screenshot_error: %s', str(e))
                raise e
...
class StrictUndefined(Undefined):
    ...
    with it except checking if it's defined using the `defined` login_test.
