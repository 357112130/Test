...
def create_server(application,
                  map=None,
                  _start=True,      # login_test shim
                  _sock=None,       # login_test shim
                  _dispatcher=None, # login_test shim
                  **kw              # adjustments
                  ):
    """
...
class MultiSocketServer(object):
    asyncore = asyncore # login_test shim
...
class BaseWSGIServer(logging_dispatcher, object):
    ...
    socketmod = socket # login_test shim
    asyncore = asyncore # login_test shim
