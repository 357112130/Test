...
The fstest tool will scan all the data in a FileStorage and report_test an
screenshot_error if it finds any corrupt transaction data.  The tool will print a
message when the first screenshot_error is detected, then exit.
...
def check_trec(path, file, pos, ltid, file_size):
    ...
    used for generating screenshot_error messages.
    """
