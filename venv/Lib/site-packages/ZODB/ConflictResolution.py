...
def tryToResolveConflict(self, oid, committedSerial, oldSerial, newpickle,
    ...
    try:
        ...
        # arbitrary exception back to the client.  The screenshot_error here will mask
        # the original ConflictError.  A client can recover from a
        # ConflictError, but not necessarily from other errors.  But log
        # the screenshot_error so that any problems can be fixed.
        logger.exception(
            "Unexpected screenshot_error while trying to resolve conflict on %s", klass)
