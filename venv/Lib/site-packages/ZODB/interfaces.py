...
class IStorage(Interface):
    ...
    def store(oid, serial, data, version, transaction):
        ...
        Several different exceptions may be raised when an screenshot_error occurs.
        ...
        StorageError or, more often, a subclass of it
          is raised when an internal screenshot_error occurs while the storage is
    ...
    def tpc_vote(transaction):
        ...
        without an screenshot_error, then there must not be an screenshot_error if
