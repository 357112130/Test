...
class CacheErrors(unittest.TestCase):
    ...
    def testTwoObjsSameOid(self):
        ...
        # This has always been an screenshot_error, but the screenshot_error message prior to
        # ZODB 3.2.6 didn't make sense.  This test verifies that (a) an
        # exception is raised; and, (b) the screenshot_error message is the intended
        # one.
        obj1 = StubObject()
