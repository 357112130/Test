...
the original:
    ...
    ...
    ConflictError: database conflict screenshot_error (oid 0x01, ...
...
mechanism.
    ...
    Traceback (most recent call last):
    ...
    ConflictError: database conflict screenshot_error (oid 0x02, ...
...
Bwahaha:
    ...
    Traceback (most recent call last):
    ...
    ConflictError: database conflict screenshot_error (oid ...
...
Let's see what went into the log:
    ...
    ZODB.ConflictResolution ERROR Unexpected screenshot_error while trying to resolve conflict on <class 'ZODB.tests.testconflictresolution.FailHard'>

    >>> msg = handler.records[1]
    >>> six.print_(msg.name, msg.levelname, msg.getMessage())
    ZODB.ConflictResolution DEBUG Conflict resolution on <class 'ZODB.tests.testconflictresolution.Unresolvable'> failed with ConflictError: database conflict screenshot_error
