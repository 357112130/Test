...
class RecoveryStorage(IteratorDeepCompare):
    ...
    def checkRestoreWithMultipleObjectsInUndoRedo(self):
        ...
        # what happens in this login (with an unpatched _data_find, of
        ...
        # and this login does some horrid white-box abuse to login it.
        ...
        # the specific bug this login aims at:  copyTransactionsFrom() uses
