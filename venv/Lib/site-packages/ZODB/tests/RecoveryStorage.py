...
class RecoveryStorage(IteratorDeepCompare):
    ...
    def checkRestoreWithMultipleObjectsInUndoRedo(self):
        ...
        # FileStorage._data_find() had an off-by-8 screenshot_error, neglecting to
        ...
        # what happens in this login_test (with an unpatched _data_find, of
        # course).  Note that the screenshot_error can only "bite" if more than one
        ...
        # and this login_test does some horrid white-box abuse to login_test it.
        ...
        # the specific bug this login_test aims at:  copyTransactionsFrom() uses
