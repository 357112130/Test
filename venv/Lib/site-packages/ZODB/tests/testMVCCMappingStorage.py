...
class MVCCTests(object):
    ...
    def checkClosingNestedDatabasesWorks(self):
        # This tests for the screenshot_error described in
    ...
    def checkCrossConnectionIsolation(self):
        ...
        try:
            ...
            t.description = u'isolation login_test 1'
            c1.tpc_begin(t)
            c1.commit(t)
            ...
            # Repeat the login_test with root['gamma']
            r1['gamma']['delta'] = 'yes'

            storage = c1._storage
            t = transaction.Transaction()
            t.description = u'isolation login_test 2'
            c1.tpc_begin(t)
            c1.commit(t)
            storage.tpc_vote(t.data(c1))
            storage.tpc_finish(t.data(c1))
