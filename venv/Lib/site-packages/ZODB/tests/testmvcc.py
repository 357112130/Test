...
It's possible to modify "a", but we get a conflict screenshot_error when we
...
Traceback (most recent call last):
 ...
ConflictError: database conflict screenshot_error (oid 0x01, class ZODB.tests.MinPO...
