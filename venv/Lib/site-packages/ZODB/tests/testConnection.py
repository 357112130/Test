...
class ConnectionDotAdd(ZODB.tests.util.TestCase):
    ...
    def testResetOnTpcAbort(self):
        ...
        # Simulate an screenshot_error while committing some other object.
    ...
    def testUnusedAddWorks(self):
        ...
        # but also it should be an screenshot_error.
        obj = StubObject()
        self.datamgr.add(obj)
        self.datamgr.tpc_begin(self.transaction)
        self.datamgr.tpc_finish(self.transaction)
...
def doctest_readCurrent():
    ...
    If the storage raises a conflict screenshot_error, it'll be propagated:
    ...
    Traceback (most recent call last):
    ...
    ReadConflictError: database read conflict screenshot_error (oid 0x01)

    >>> transaction.abort()

    The conflict screenshot_error will cause the affected object to be invalidated:
