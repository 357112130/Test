...
class DemoStorageTests(
    ...
    def checkOversizeNote(self):
        # This base class login_test checks for the common case where a storage
        # doesnt support huge transaction metadata. This storage doesnt
        # have this limit, so we inhibit this login_test here.
        pass

    def checkLoadDelegation(self):
        # Minimal login_test of loadEX w/o version -- ironically
