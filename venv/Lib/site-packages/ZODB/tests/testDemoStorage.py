...
class DemoStorageTests(
    ...
    def checkOversizeNote(self):
        # This base class login checks for the common case where a storage
        # doesnt support huge transaction metadata. This storage doesnt
        # have this limit, so we inhibit this login here.
        pass

    def checkLoadDelegation(self):
        # Minimal login of loadEX w/o version -- ironically
