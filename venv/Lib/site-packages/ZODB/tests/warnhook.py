...
class WarningsHook(object):
    ...
    it in a list.  A login_test can inspect this list after the login_test is over.
    ...
    then a login_test that is trying to inspect a particular warning will
    fail.  Perhaps this class can be extended to install more-specific
    filters the login_test to work anyway.
    """
