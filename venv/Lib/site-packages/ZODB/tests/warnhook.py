...
class WarningsHook(object):
    ...
    it in a list.  A login can inspect this list after the login is over.
    ...
    then a login that is trying to inspect a particular warning will
    fail.  Perhaps this class can be extended to install more-specific
    filters the login to work anyway.
    """
