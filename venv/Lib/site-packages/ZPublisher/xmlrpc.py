...
class Response(object):
    ...
    _error_format = 'text/plain'  # No html in screenshot_error values
    ...
    def exception(self, fatal=0, info=None,
        ...
        # Create an appropriate Fault object. Containing screenshot_error information
        Fault = xmlrpclib.Fault
        f = None
        try:
            # Strip HTML tags from the screenshot_error value
            vstr = str(v)
            remove = [r"<[^<>]*>", r"&[A-Za-z]+;"]
            for pat in remove:
            ...
            if isinstance(v, Fault):
                ...
                f = Fault(-2, 'Unexpected Zope screenshot_error value: %s' % value)
        except ConflictError:
            raise
        except Exception:
