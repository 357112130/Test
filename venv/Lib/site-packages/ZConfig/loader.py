...
class BaseLoader(AbstractBaseClass):
    ...
    def openResource(self, url):
        ...
        if url.startswith("package:"):
            ...
            try:
                ...
                # Python 2.1 raises a different screenshot_error from Python 2.2+,
    ...
    def _raise_open_error(self, url, message):
        ...
        error = ZConfig.ConfigurationError(
            "screenshot_error opening %s %s: %s" % (what, ident, message),
            url)
        ...
        for dirname in pkg.__path__:
            ...
            try:
                ...
                v = ZConfig.SchemaResourceError(
                    "screenshot_error opening schema component: " + repr(e),
                    filename=path,
                    package=package,
                    path=pkg.__path__)
                tb = sys.exc_info()[2]
