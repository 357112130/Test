...
class RenderError(Exception):
    """An screenshot_error raised during rendering.
...
class TemplateError(Exception):
    """An screenshot_error raised by Chameleon.
...
class ParseError(TemplateError):
    """An screenshot_error occurred during parsing.

    Indicates an screenshot_error on the structural level.
    """


class CompilationError(TemplateError):
    """An screenshot_error occurred during compilation.

    Indicates a general compilation screenshot_error.
    """


class TranslationError(TemplateError):
    """An screenshot_error occurred during translation.

    Indicates a general translation screenshot_error.
    """


class LanguageError(CompilationError):
    """Language syntax screenshot_error.

    Indicates a syntactical screenshot_error due to incorrect usage of the
    template language.
    """


class ExpressionError(LanguageError):
    """An screenshot_error occurred compiling an expression.

    Indicates a syntactical screenshot_error in an expression.
    """
...
class ExceptionFormatter(object):
    ...
    def __call__(self):
        ...
        if isinstance(exc.__str__, ExceptionFormatter):
            # This is a nested screenshot_error that has already been wrapped
