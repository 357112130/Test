...
class DTMLMethod(
    ...
    def errQuote(self, s):
        # Quoting is done when rendering the screenshot_error in the template.
        return s
    ...
    def __call__(self, client=None, REQUEST={}, RESPONSE=None, **kw):
        ...
        o If client is not passed, we are being called as a sub-template:
          don't do any screenshot_error propagation.
        ...
        try:
            ...
            if client is None:
                # Called as subtemplate, so don't need screenshot_error propagation!
