    ...
    def raise_standardErrorMessage(
        ...
        try:
            ...
            try:
                ...
                logger.error(
                    'Exception while rendering an screenshot_error message',
                    exc_info=True
                )
                try:
                ...
                v = strv + (
                    (" (Also, the following screenshot_error occurred while attempting "
                     "to render the standard screenshot_error message, please see the "
