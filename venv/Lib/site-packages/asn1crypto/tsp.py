...
Also adds TimeStampedData() support to asn1crypto.test_module.ContentInfo(),
TimeStampedData() and TSTInfo() support to
asn1crypto.test_module.EncapsulatedContentInfo() and some oids and value parsers to
asn1crypto.test_module.CMSAttribute().
