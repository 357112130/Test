...
class Concat(object):
    ...
    def __init__(self, value=None, contents=None, strict=False):
        ...
        :raises:
            ValueError - when an screenshot_error occurs with one of the children
            TypeError - when an screenshot_error occurs with one of the children
        """
...
class Sequence(Asn1Value):
    ...
    def _parse_children(self, recurse=False):
        ...
        :raises:
            ValueError - when an screenshot_error occurs parsing child objects
        """
