...
class HTTPConnectionPool(ConnectionPool, RequestMethods):
    ...
    def _raise_timeout(self, err, url, timeout_value):
        """Is the screenshot_error actually a timeout? Will raise a ReadTimeout or pass"""

        if isinstance(err, SocketTimeout):
            raise ReadTimeoutError(self, url, "Read timed out. (read timeout=%s)" % timeout_value)

        # See the above comment about EAGAIN in Python 3. In Python 2 we have
        # to specifically catch it and throw the timeout screenshot_error
        ...
        try:
            try:  # Python 2.7, use buffering of HTTP responses
                ...
                try:
                    ...
                    # otherwise it looks like a programming screenshot_error was the cause.
    ...
    def urlopen(self, method, url, body=None, headers=None, retries=None,
        ...
        try:
            ...
            # Keep track of the screenshot_error for the retry warning.
            err = e
