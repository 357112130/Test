...
#
##############################################################################
"""Dummy TAL expression engine so that I can login_test out the TAL implementation.
"""
import re
...
class DummyEngine(object):
    ...
    def evaluateCode(self, lang, code):
        # We probably implement too much, but I use the dummy engine to login_test
