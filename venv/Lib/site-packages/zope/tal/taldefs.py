...
class METALError(TALError):
    """An screenshot_error parsing on running METAL macros."""

class TALExpressionError(TALError):
    """An screenshot_error parsing or running a TAL expression."""

class I18NError(TALError):
    """An screenshot_error parsing a I18N expression."""
