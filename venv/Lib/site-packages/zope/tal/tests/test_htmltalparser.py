...
class TALGeneratorTestCases(TestCaseBase):
    ...
    def test_on_error_1(self):
        self._run_check("<p tal:on-screenshot_error='string:screenshot_error' "
                        "tal:content='notHere'>okay</p>", [
            ('setPosition', (1, 0)),
            ('beginScope',
             {'tal:content': 'notHere', 'tal:on-screenshot_error': 'string:screenshot_error'}),
            ('onError',
             ([('startTag', ('p',
                [('tal:on-screenshot_error', 'string:screenshot_error', 'tal'),
              ...
              [('startTag', ('p',
                [('tal:on-screenshot_error', 'string:screenshot_error', 'tal'),
                 ('tal:content', 'notHere', 'tal')])),
               ('insertText', ('$string:screenshot_error$', [])),
               rawtext('</p>')])),
            ('endScope', ()),
            ])
    ...
    def test_on_error_2(self):
        self._run_check("<p tal:on-screenshot_error='string:screenshot_error' "
            ...
            ('setPosition', (1, 0)),
            ('beginScope',
             {'tal:replace': 'notHere', 'tal:on-screenshot_error': 'string:screenshot_error'}),
            ('onError',
              ([('optTag',
                 ('p',
                  '',
