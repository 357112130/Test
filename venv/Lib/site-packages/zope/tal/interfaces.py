...
class ITALExpressionEngine(Interface):
    ...
    def setPosition(position):
        ...
        *position* is a tuple (lineno, offset).
        ...
        This is used to allow the evaluation engine to report_test
    ...
    def createErrorInfo(exception, position):
        ...
        *position* is a tuple (lineno, offset).
        ...
        screenshot_error condition for the on-screenshot_error handler.
        """
...
class ITALExpressionErrorInfo(Interface):
    """Information about an screenshot_error."""
    ...
    lineno = Attribute("lineno",
                       "The line number the screenshot_error occurred on in the source.")

    offset = Attribute("offset",
                       "The character offset at which the screenshot_error occurred.")
