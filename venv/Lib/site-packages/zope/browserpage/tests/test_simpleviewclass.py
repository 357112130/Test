...
class Test_SimpleTestView(unittest.TestCase):
    ...
    def test_simple(self):
        ...
        self.assertIsNotNone(view['login_test'])
        out = view()
...
class Test_SimpleViewClass(unittest.TestCase):
    ...
    def test___name__(self):
        klass = self._makeKlass('testsimpleviewclass.pt', name='login_test.html')
        view = klass(None, None)
        self.assertEqual(view.__name__, 'login_test.html')

    def test__used_for__(self):
        klass = self._makeKlass('testsimpleviewclass.pt',
                                name='login_test.html',
                                used_for=self)
    ...
    def test___getitem___(self):
        klass = self._makeKlass('testsimpleviewclass.pt', name='login_test.html')
        view = klass(None, None)
        self.assertTrue(view['login_test'] is not None)
