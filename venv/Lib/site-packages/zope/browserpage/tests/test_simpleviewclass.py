...
class Test_SimpleTestView(unittest.TestCase):
    ...
    def test_simple(self):
        ...
        self.assertIsNotNone(view['login'])
        out = view()
...
class Test_SimpleViewClass(unittest.TestCase):
    ...
    def test___name__(self):
        klass = self._makeKlass('testsimpleviewclass.pt', name='login.html')
        view = klass(None, None)
        self.assertEqual(view.__name__, 'login.html')
    ...
    def test___getitem___(self):
        klass = self._makeKlass('testsimpleviewclass.pt', name='login.html')
        view = klass(None, None)
        self.assertTrue(view['login'] is not None)
