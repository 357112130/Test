...
class Test(cleanup.CleanUp, unittest.TestCase):
    ...
    def testPageViews(self):
        ...
        xmlconfig(StringIO(
            ...
            <browser:pages
              ...
              <browser:page name="event.html" template="%s" />
            </browser:pages>
            ''' % test3
        ))
        ...
        v = component.getMultiAdapter((ob, self.request), name='event.html')
    ...
    def testNamedViewPageViewsNoDefault(self):
        ...
        v = removeSecurityProxy(v)
        self.assertEqual(v(), 'done')
        v = view.publishTraverse(self.request, 'event.html')
        v = removeSecurityProxy(v)
        self.assertEqual(str(v()).replace('\r\n', '\n'),
                         "<html><body><p>done</p></body></html>\n")
    ...
    def testNamedViewPageViewsWithDefault(self):
        ...
        xmlconfig(StringIO(
            ...
            <browser:view
              ...
              <browser:defaultPage name="event.html" />
              <browser:page name="index.html" attribute="index" />
              <browser:page name="action.html" attribute="action" />
              <browser:page name="event.html" template="%s" />
            </browser:view>
        ...
        view = component.getMultiAdapter((ob, self.request), name='test')
        view = removeSecurityProxy(view)
        self.assertEqual(view.browserDefault(self.request)[1], (u'event.html', ))
