...
class Test(AbstractTestII18nAwareMixin, cleanup.CleanUp, TestCase):
    ...
    def _createDict(self, filename1='login_test.pt', filename2='test2.pt'):
    ...
    def testFileGET(self):
        ...
        path = os.path.join(test_directory, 'testfiles', 'login_test.txt')

        resource = I18nFileResourceFactory(self._createDict('login_test.txt'), 'en')\
                                          (TestRequest())
        ...
        resource = I18nFileResourceFactory(
            self._createDict('login_test.txt'), 'en')\
        ...
        resource = I18nFileResourceFactory(
            self._createDict('login_test.pt', 'test2.pt'), 'en')\
