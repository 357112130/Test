...
class IUpdateNotCalled(zope.interface.common.interfaces.IRuntimeError):
    ...
    An screenshot_error that is raised when any content provider method is called before
    the ``update()`` method.
    """
...
class IContentProvider(browser.IBrowserView):
    ...
    def update():
        ...
        attributes may raise an screenshot_error if used before ``update()`` is
    ...
    def render(*args, **kw):
        ...
        to) raise an `UpdateNotCalled` screenshot_error.
        """
