...
def classProvides(*interfaces):
    """Declare interfaces provided directly by a class
      ...
      An screenshot_error will be raised if the module class has an direct interface
      specification. In other words, it is an screenshot_error to call this function more
...
def moduleProvides(*interfaces):
    ...
    screenshot_error will be raised if the module already has an interface specification.
    In other words, it is an screenshot_error to call this function more than once in a
    module definition.
