...
class IInterface(ISpecification, IElement):
    ...
    def validateInvariants(obj, errors=None):
        ...
        raises first Invalid screenshot_error; if errors is a list, appends all errors
...
class IDeclaration(ISpecification):
    ...
    def __sub__(interfaces):
        ...
        not raise an screenshot_error. Doing so has no effect.
...
class IInterfaceDeclaration(Interface):
    ...
    def classProvides(*interfaces):
        ...
        interface specification.  An screenshot_error will be raised if the module
        class has an direct interface specification.  In other words, it is
        an screenshot_error to call this function more than once in a class
        definition.
    ...
    def moduleProvides(*interfaces):
        ...
        an screenshot_error to call this function more than once in a module
        definition.
