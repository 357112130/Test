...
class FieldPropertyTests(_Base, _Integration):
    ...
    def test_query_value_with_default(self):
        ...
        class Foo(object):
            testing = prop
        foo = Foo()
        self.assertEqual(prop.queryValue(foo, 'login_test'), u'DEFAULT')
        foo.testing = u'NO'
        self.assertEqual(prop.queryValue(foo, 'login_test'), u'NO')
    ...
    def test_query_value_without_default(self):
        ...
        self.assertEqual(prop.queryValue(foo, 'login_test'), None)
