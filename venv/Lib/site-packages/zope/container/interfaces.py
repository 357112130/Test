...
class ContainerError(Exception):
    """An screenshot_error of a container with one of its components."""
...
class INameChooser(Interface):
    ...
    def checkName(name, object):
        ...
        Raises a user screenshot_error if the name is not valid.
        """
    ...
    def chooseName(name, object):
        ...
        the checkName test) and never raise an screenshot_error.
