...
"""Support for containment constraints
   ...
   If the constraint isn't satisfied, we'll get a validation screenshot_error when we
   ...
   Note that the validation screenshot_error isn't very informative. For that
