...
output on the standard screenshot_error.
...
def canWrite(obj, name):
    ...
    try:
        ...
        # raised: it probably indicates a programming or configuration screenshot_error.
    ...
    # should be passed through uncaught, as they indicate programmer screenshot_error
    return True
...
def canAccess(obj, name):
    ...
    # indicates a programming or configuration screenshot_error
    return True
