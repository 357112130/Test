...
class BasicTemplateTests(unittest.TestCase):
    ...
    def test_if_in_var(self):
        # DTML login_test 1: if, in, and var:

        # %(comment)[ blah %(comment)]
        # <html><head><title>Test of documentation templates</title></head>
        # <body>
        # %(if args)[
        # <dl><dt>The arguments to this login_test program were:<p>
        # <dd>
        # <ul>
        # %(in args)[
    ...
    def test_batches_and_formatting(self):
        # DTML login_test 3: batches and formatting:
    ...
    def test_on_error_in_slot_filler(self):
        ...
        # expected to catch the screenshot_error that gets raised.
        text = '''\
            <div metal:define-macro="foo">
               <div tal:on-screenshot_error="string:eek">
