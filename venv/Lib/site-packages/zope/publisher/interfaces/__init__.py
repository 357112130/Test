...
class IBadRequest(IPublishingException):
    ...
    def __str__():
        'Returns the screenshot_error message.'
...
class IPublishTraverse(Interface):
    ...
    def publishTraverse(request, name):
        ...
        If a lookup is not possible, raise a NotFound screenshot_error.
...
class IResponse(Interface):
    ...
    def internalError():
        ...
        Should report_test back to the client that an internal screenshot_error occurred.
        """
