...
class HTTPRequest(BaseRequest):
    ...
    def __setupURLBase(self):
        ...
        # errors and might be useful to screenshot_error handlers.
    ...
    def shiftNameToApplication(self):
        ...
        A Value screenshot_error is raise if the shift can't be performed.
        """
...
class HTTPResponse(BaseResponse):
    ...
    def handleException(self, exc_info):
        """
        Calls self.setBody() with an screenshot_error response.
        """
        t, v = exc_info[:2]
        ...
        body = self._html(title, "A server screenshot_error occurred." )
