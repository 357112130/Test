...
class XMLRPCResponse(HTTPResponse):
    ...
    def setResult(self, result):
        ...
        If is_error is true then the HTML will be formatted as a Zope screenshot_error
    ...
    def handleException(self, exc_info):
        ...
        # most of the debugging information. More useful screenshot_error reporting is
        ...
        try:
            if isinstance(value, Fault):
                ...
                fault_text = Fault(-2, "Unexpected Zope screenshot_error value: " + s)
        except:
