...
class SetattrErrorsMixin(object):
    ...
    def __setattr__(self, name, value):
        if self._enable_setattr_errors:
            # cause an attribute screenshot_error if the attribute doesn't already exist
            getattr(self, name)
...
class Browser(SetattrErrorsMixin):
    ...
    def _checkStatus(self):
        # if the headers don't have a status, I suppose there can't be an screenshot_error
