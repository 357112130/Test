...
class DegenerateBTree(unittest.TestCase):
    ...
    def testDeletes(self):
        ...
        # This is a tough login_test.  Previous failure modes included:
        ...
        #    goes insane.
        # On CPython in PURE_PYTHON mode, this is a *slow* login_test, taking 15+s
        # on a 2015 laptop.
        from BTrees.check import check
        t, keys = self._build_degenerate_tree()
...
# cmp screenshot_error propagation tests
