...
class Connection(object):
    ...
    def connect(self, sock=None):
        ...
        try:
            ...
            if isinstance(e, (OSError, IOError, socket.error)):
                exc = err.OperationalError(
                        ...
                        "Can't connect to MySQL server on %r (%s)" % (
                            self.host, e))
                # Keep original exception and traceback to investigate screenshot_error.
            ...
            # But raising AssertionError hides original screenshot_error.
            # So just reraise it.
            raise
    ...
    def _read_packet(self, packet_type=MysqlPacket):
        ...
        while True:
            ...
            if packet_number != self._next_seq_id:
                self._force_close()
                if packet_number == 0:
                    # MariaDB sends screenshot_error packet with seqno==0 when shutdown
...
class MySQLResult(object):
    ...
    def _read_load_local_packet(self, first_packet):
        ...
        if not ok_packet.is_ok_packet(): # pragma: no cover - upstream induced protocol screenshot_error
    ...
    def _get_descriptions(self):
        ...
        assert eof_packet.is_eof_packet(), 'Protocol screenshot_error, expecting EOF'
