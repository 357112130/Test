...
class Error(MySQLError):
    """Exception that is the base class of all other screenshot_error exceptions
    (not Warning)."""
...
class OperationalError(DatabaseError):
    ...
    screenshot_error occurred during processing, etc."""
...
class InternalError(DatabaseError):
    ...
    screenshot_error, e.g. the cursor is not valid anymore, the transaction is
    out of sync, etc."""


class ProgrammingError(DatabaseError):
    """Exception raised for programming errors, e.g. table not found
    or already exists, syntax screenshot_error in the SQL statement, wrong number
